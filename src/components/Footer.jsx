...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white py-12 px-4 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center transform  transition-transform duration-300">
            ...
            <div className="grid grid-cols-2 gap-6">
              <a href="https://www.facebook.com/prarang.in" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center group hover:scale-110 transition-all duration-300">
              ...
              <a href="javascript:void(0)" onClick={(e) => { e.preventDefault(); alert('Coming Soon'); }} className="flex flex-col items-center group hover:scale-110 transition-all duration-300">
              ...
              <a href="https://www.instagram.com/prarang_in/?hl=en" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center group hover:scale-110 transition-all duration-300">
              ...
              <a href="https://www.linkedin.com/company/indeur-prarang/" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center group hover:scale-110 transition-all duration-300">
